...
blModalTitleLogo.setAttribute('data-src', 'logo.png');
...
blLearnMoreVideo.innerHTML = '<div id="bl-learn-more-title">We want help making {productName} better for you.</div><div class="bl-learn-more-content">By joining our beta-test list, you&rsquo;ll have the opportunity to take part by:</div><div class="bl-learn-more-content">&bull; accessing early features &amp; prototypes</div><div class="bl-learn-more-content">&bull; giving detailed feedback on existing features</div><div class="bl-learn-more-content">&bull; helping define the product roadmap</div><div class="bl-learn-more-content">Choose what you want to help us out with. Unsubscribe anytime.</div>';
...
function loadImages() {
	var blSuccessImgSrc = blModalSuccessImg.getAttribute('data-src');
	
	if(narrowWindow) {
		blMobileModalSuccessImg.style.backgroundImage = 'url('+ blSuccessImgSrc +')';
	} else {
		blModalSuccessImg.setAttribute('src', blSuccessImgSrc);
	}
}
function showModal() {
	var blLogoImgSrc = blModalTitleLogo.getAttribute('data-src');
	
	blModalTitleLogo.setAttribute('src', blLogoImgSrc);

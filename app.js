...
function showSuccessMsg() {
	setTimeout(function() {
		...
		// removeUIAfterSubmit(); TODO, maybe add back in
		loadImages();
	}, 1250);
	setTimeout(function() {
...
blForm.onsubmit = function(e) {
	...
	if(!validateEmail(blEmail.value)) {
		...
		blSubmit.innerHTML = 'Joining&hellip;';
		blSubmit.blur();
	}
}

...
blModalTitleContent.innerText = 'We want you to help us improve {productName}.';
blModalTitleSmall.id = 'bl-modal-title-micro';
blModalTitleSmall.innerHTML = 'Take part in beta &amp; user tests so we can make {productName} better for you. ';
...
blLearnMoreVideo.innerHTML = '<div id="bl-learn-more-title"><!--We want help making {productName} better for you.-->Join our betalist and make {productName} better for you.</div><div class="bl-learn-more-content">By joining our betalist, you&rsquo;ll have the opportunity to take part by:</div><div class="bl-learn-more-content">&bull; accessing early features &amp; prototypes</div><div class="bl-learn-more-content">&bull; giving detailed feedback on existing features</div><div class="bl-learn-more-content">&bull; helping define the product roadmap</div><div class="bl-learn-more-content">Choose what you want to help us out with. Unsubscribe anytime.</div>';

...
function showModal() {
	...
	bodyClassOriginal = body.className; // get original body class names
	body.className += ' modal-is-shown';
	body.style.height = window.innerHeight + 'px';
	if(narrowWindow) {
		body.className += ' is-mobile-device';
		setTimeout(function() {
			body.className += ' is-fixed';
		}, 500);
	}
}
function closeAndResetModal() {
	...
	body.className = bodyClassOriginal; // reset original body class names
	body.style.height = '';
	if(narrowWindow) {
